...
<section class="elonlar flex flex-col items-start gap-[24px] gap-sm-2 my-4 my-sm-5 px-2 mt-[100px] sm:px-12">
  <h1 class="text-3xl font-bold outline-0">Hamrohlar</h1>
 <div class="flex flex-col justify-between items-start w-full gap-2 bg-indigo-900 p-8 rounded-xl">
